          ...
          body: ListView(
            ...
            children: [
              ...
              GlassContainer(
                ...
                child: Column(
                  children: [
                    const Text('INSTANT ESTIMATED VALUE',
                        style: TextStyle(
              ...
              Wrap(
                spacing: 8,
                children:
                    ['Apple', 'Samsung', 'Google', 'Siaka', 'Other'].map((b) {
              ...
              // Cosmetic Condition
              const Text('4. Cosmetic Condition',
                  style: TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      fontSize: 14)),
              ...
              GlassContainer(
                ...
                child: Column(
                  children: [
                    SwitchListTile(
                      title: const Text('Device powers on & stays on',
                    ...
                    SwitchListTile(
                      title: const Text(
                          'Screen is intact (no dead pixels/burn-in)',
                          style: TextStyle(color: Colors.white, fontSize: 13)),
              ...
              NeonButton(
                label:
                    'Apply ₵${viewModel.estimatedQuote.toStringAsFixed(0)} Credit at Checkout',
                ...
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                        content: Text(
                            'Trade-in credit of ₵${viewModel.estimatedQuote.toStringAsFixed(0)} locked for 14 days!')),
                  );
                  onApplyToPurchase();
                },
              ),
